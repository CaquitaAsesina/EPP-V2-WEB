...
const Router = {
  ...
  runScript(doc) {
    ...
    /* Interceptar DOMContentLoaded: las vistas lo registran pero el evento ya pasó.
       Invocamos los handlers diferidos vía setTimeout para simular el timing real. */
